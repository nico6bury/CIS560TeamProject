...
namespace WebAPI.Controllers {
    ...
    public class RetrieveAllItemsInTables : Controller {

        public RetrieveAllItemsInTables(IItemRepo items, IItemCategoryRepo cat, IUserRepo users) {
            Items = items;
            Categories = cat;
            Users = users;
        }
        ...
        public List<NewTableWithItems> RetrieveAllItemsInTablesGet(string json) {
            ...
            try {
                IReadOnlyList<ItemCategory> cats = Categories.RetrieveItemCategoriesForUserID(userId.UserId);
