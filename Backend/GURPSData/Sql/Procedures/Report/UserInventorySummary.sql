...
ON II.InventoryID = ENR.InventoryID RIGHT JOIN GeneratedItems.CreatedEmbellishment CEM
ON EMR.CreatedEmbellishmentID = CEM.CreatedEmbellishmentID RIGHT JOIN
