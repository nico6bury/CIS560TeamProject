...
DROP PROCEDURE IF EXISTS AppRecords.SaveEnchantmentCategory;
DROP PROCEDURE IF EXISTS AppRecords.SaveEnchantment;
DROP PROCEDURE IF EXISTS AppRecords.SaveEmbellishmentCategory;
DROP PROCEDURE IF EXISTS AppRecords.SaveEmbellishment;
DROP PROCEDURE IF EXISTS AppRecords.SaveUser;
DROP PROCEDURE IF EXISTS AppRecords.SaveItemCategory;
DROP PROCEDURE IF EXISTS AppRecords.SaveItem;
DROP PROCEDURE IF EXISTS GeneratedItems.SaveInventoryItem;
DROP PROCEDURE IF EXISTS GeneratedItems.SaveCreatedEnchantment;
DROP PROCEDURE IF EXISTS GeneratedItems.SaveCreatedEmbellishment;

DROP PROCEDURE IF EXISTS GeneratedItems.DeleteEmbellishmentRef;
DROP PROCEDURE IF EXISTS GeneratedItems.DeleteEnchantmentRef;
